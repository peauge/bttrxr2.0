...
function calculateBuy(obj){
    ...
    if (argv.m && argv.m > 0.1 && argv.f == null) {
      console.log("Cannot place an order with a margin over 10% of the lowestAsk without the -f argument!\n Order placed at the lowestAsk without margin.")
    } else {
      margin = argv.m ? argv.m : 0;
    }
    var rate = argv.r ? argv.r : obj.lowestAsk + obj.lowestAsk * margin;
    var amount = 0;
    var baseAmount = 0;
