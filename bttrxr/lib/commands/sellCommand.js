...
function calculateSell(obj){
    ...
    var margin = 0;
    if (argv.m && argv.m < -0.1 && argv.f == null) {
      console.log("Cannot place an order with a margin under 10% of the highestBid without the -f argument!\n Order placed at the highestBid without margin.")
    } else {
      margin = argv.m ? argv.m : 0;
    }
    var rate = argv.r ? argv.r : obj.highestBid + obj.highestBid * margin;
    var amount = 0;
    var baseAmount = 0;
